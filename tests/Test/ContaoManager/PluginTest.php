...
namespace MetaModels\AttributeUrlBundle\Test\ContaoManager;

use Contao\ManagerPlugin\Bundle\BundlePluginInterface;
use Contao\ManagerPlugin\Bundle\Config\BundleConfig;
use Contao\ManagerPlugin\Bundle\Parser\ParserInterface;
use MetaModels\AttributeUrlBundle\ContaoManager\Plugin;
 ...
 *
 * @covers \MetaModels\AttributeUrlBundle\ContaoManager\Plugin
 */
class PluginTest extends TestCase
{
    ...
    public function testBundleConfig()
    {
        ...
        $this->assertEquals($bundleConfig->getReplace(), ['metamodelsattribute_url']);
    }
}
